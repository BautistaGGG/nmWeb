          ...
          <aside className="grid content-between">
            <div className="grid gap-4 grid-rows-2 lg:grid-rows-none items-center lg:items-stretch">
              <svg
                ...
                className="ml-auto mr-auto lg:mr-0 h-10 lg:h-[72px] w-10 lg:w-20 lg:self-auto"
              >
                <path
              ...
              <p className="text-gris text-base lg:text-xl text-center lg:text-right font-semibold ml-auto">
            ...
            <div className="grid gap-4 grid-rows-2 lg:grid-rows-none items-center lg:items-stretch">
              ...
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="ml-auto mr-auto lg:mr-0 h-10 lg:h-[72px] w-10 lg:w-20"
              >
                <path
          ...
          <aside className="grid content-between">
            <div className="grid gap-4 grid-rows-2 lg:grid-rows-none items-center lg:items-stretch">
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="bg-white lg:bg-none rounded-full lg:rounded-none h-10 lg:h-[72px] w-10 lg:w-20 ml-auto mr-auto lg:ml-0"
              >
                <path
              ...
              <p className="text-white md:text-gris text-base lg:text-xl text-center lg:text-left font-semibold">
            ...
            <div className="grid gap-4 grid-rows-2 lg:grid-rows-none items-center lg:items-stretch">
              ...
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="ml-auto mr-auto lg:ml-0 h-10 lg:h-[72px] w-10 lg:w-20 lg:self-auto"
              >
                <path
