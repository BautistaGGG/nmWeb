      ...
      <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        ...
        <div className="space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0">
          ...
          <div className="bg-[#040404] rounded-lg p-8">
            ...
            <h3 className="mb-2 text-center md:text-left text-xl text-[#FF3399] font-bold">
          ...
          <div className="bg-[#040404] rounded-lg p-8">
            ...
            <h3 className="mb-2 text-center md:text-left text-xl text-[#FF3399] font-bold dark:text-white">
