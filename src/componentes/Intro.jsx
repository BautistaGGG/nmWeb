            ...
            <article className="gap-16 items-start py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
                ...
                <aside className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                    <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-white dark:text-white"> 
                        Nuevos <span className='italic'> HABITOS </span> <span className="text-[#82027D] ml-1"> + </span>
                    </h2>
                    <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-white dark:text-white"> 
                        Nueva <span className='italic'> MENTALIDAD </span> <span className="text-[#82027D] ml-1"> + </span>
                    </h2>
                    <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-white dark:text-white"> 
                        Nuevo <span className='italic'> FISICO </span> <span className="text-[#82027D] ml-1"> = </span>
                    </h2>
                    <h2 className="mb-4 italic text-4xl tracking-tight font-extrabold text-[#82027D] dark:text-white">
                         TRANSFORMACIÓN 
                    </h2>
                    <p className="mb-4">
                        Tu viaje hacia una versión más fuerte y saludable de vos mismo COMIENZA ACÁ. Vas a descubrir el poder de desafiar tus límites y superar tus metas. Imaginate despertar cada mañana sintiéndote más enérgico, más fuerte y más vibrante. Mi plan de entrenamiento no es solo una rutina, es un compromiso con vos mismo para alcanzar el cuerpo de tus sueños.
                    </p>
                </aside>
                ...
                <div className="flex flex-col font-light text-white sm:text-lg dark:text-gray-400">
                    ...
                    <p className="my-4 text-white">
                        ...
                        <p>
                            ...
                            bien, no entrenaba lo suficiente, no me sentía bien conmigo mismo, tenía el 
                            autoestima por el piso, me sentía incómodo con mi cuerpo, me daba 
                            vergüenza mostrarme en ropa de baño, pero un día llego el momento de 
                            cambiar. 
                        </p>
                        <p>
                            Me enfoque en CRECER, tanto en lo personal, como en lo profesional, 
                            pero saben cómo se logra? Incorporando HÁBITOS y CONSTANCIA, trabajo duro, 
                            yo les aseguro que se puede. Hoy, varios años después, acompañado de 
                            un equipo de trabajo, me dedico cada día en poder ayudar a personas a cambiar su vida. 
                        </p> 
                        <p>
                            Es muy satisfactorio ver cómo se pueden superar, cómo crece su autoestima, cómo incorporan
                            hábitos, y por sobre todas las cosas, mejorar su salud y calidad de vida. 
