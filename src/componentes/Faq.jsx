      ...
      >
        ...
        <h2 id="accordion-collapse-heading-1">
          ...
          >
            ...
            <svg data-accordion-icon className="w-3 h-3 rotate-180 shrink-0 transition-all hover:w-5 hover:h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
        ...
        >
          <div className="p-5">
            <p className="mb-2 text-gris">
              Una vez realizado el pago, nos vamos a contactar con vos vía E-mail
              para confirmar la compra y enviarte las herramientas que incluye el
              plan seleccionado.
            </p>
          </div>
        </div>
        ...
        >
          <div className="p-5 dark:border-gray-700 dark:bg-gray-900">
            <p className="mb-2 text-gris">
              Por supuesto que podes hacer el plan de entrenamiento en tu hogar o
              en espacios abiertos. Es necesario saber con que material contas
